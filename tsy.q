...
// Third business day of the month (for TU/FV last delivery)
thirdBizDay:{[ym]
    d:firstBizDay ym;
    d:nextBizDay d + 1;  // 2nd biz day
    nextBizDay d + 1}    // 3rd biz day

// Last delivery day - contract dependent:
// - TU/FV: 3rd business day of delivery month
// - TY/US/WN: last business day of delivery month (or next if weekend)
lastDeliveryDay:{[ym]
    d:lastOfMonth ym;
    nextBizDay d}

// Contract-specific last delivery day
// TU and FV deliver by the 3rd business day of delivery month
// TY, US, WN deliver by last business day of delivery month
