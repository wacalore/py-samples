...
dailyCTD:{[baskets;prices;futures;curves;repoRate]
    ...
    curvesByDate:$[curveType=`dict; dates!nDates#enlist curves;
                   ...
                   curveType=`table; (exec date!curve from curves) dates;
    ...
    repoByDate:$[-9h=type repoRate; dates!nDates#repoRate;
                 ...
                 98h=type repoRate; (exec date!rate from repoRate) dates;
    ...
    deliveryDateByCode:deliveryCodes!{[bc;dc] firstDeliveryDay first bc[dc]`deliveryMonth}[basketsByCode;] each deliveryCodes;
