...
parseAuctionResponse:{[data]
    if[0 = count data; :([] cusip:`symbol$(); securityType:`symbol$();
        ...
        isReopening:`boolean$(); announcementDate:`date$())];
    ...
    // offering_amt is in full dollars (e.g., "69000000000" = $69B)
    ...
    ([] cusip:cusips; securityType:secTypes; coupon:coupons;
        ...
        isReopening:isReopen; announcementDate:announceDates)}
...
loadAuctionCache:{[]
    ...
    auctions:("SSFDDDSFBD";enlist csv) 0: path;
