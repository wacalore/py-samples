...
// Last delivery day - if last calendar day is weekend/holiday, delivery
// can occur on next business day (may be in following month)
lastDeliveryDay:{[ym]
    d:lastOfMonth ym;
    nextBizDay d}
...
dailyNearestSwitchPoint:{[baskets;prices;futures;curves;repoRate;maxShift;useLastDelivery]
    ...
    deliveryDateLastByCode:deliveryCodes!{[bc;dc] lastDeliveryDay first bc[dc]`deliveryMonth}[basketsByCode;] each deliveryCodes;
    contractByCode:deliveryCodes!{[bc;dc] first bc[dc]`contract}[basketsByCode;] each deliveryCodes;
    monthByCode:deliveryCodes!{[bc;dc] first bc[dc]`deliveryMonth}[basketsByCode;] each deliveryCodes;
