...
help:{[]
    ...
    -1 "  simPaths1D[x;n;meth;params]      - generate n forward paths";
    -1 "  simSignalChange[x;fn;n;m;p]      - expected signal change (mean+std)";
    -1 "  simEmaZscore[x;hl;w;n;m;p]       - simulate EMA z-score change";
    -1 "  simRzscore[x;w;n;m;p]            - simulate rolling z-score change";
    -1 "  autoSimParams[x;w;method]        - auto-estimate sim params";
