...
yieldToMaturity:{[settleDate;maturityDate;coupon;couponFreq;faceValue;cleanPrice]
    ...
    // Price and duration at given yield
    priceDur:{[cfs;cfYFs;ytm]
        dfs:exp neg ytm * cfYFs;
        pv:sum cfs * dfs;
        dur:neg sum cfs * cfYFs * dfs;  // dP/dy (negative)
        (pv;dur)
    }[cfs;cfYFs;];
...
conversionFactor:{[deliveryDate;maturityDate;coupon;couponFreq]
    ...
    n:quarters div 2;  // Number of semi-annual periods (integer division)
