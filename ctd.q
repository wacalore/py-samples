...
nearestSwitchPoint:{[curve;settleDate;deliveryDate;futuresPrice;repoRate;bonds;maxShift]
    ...
    bondInfo:{[settle;delivery;b]
        ...
        cpnAccrual:couponAccrualBetween[settle;delivery;b`maturity;b`coupon;`SA;100f];
        `sym`coupon`maturity`cf`ytm`aiSettle`aiDelivery`cpnAccrual!(
            b`sym;b`coupon;b`maturity;b`cf;ytm;aiSettle;aiDelivery;cpnAccrual)
    ...
    fastCTD:{[fut;daysToDeliv;settle;bondInfo;shift]
        ...
        repos:{[fut;days;settle;shift;bi]
            ...
            numerator:invoicePrice + bi[`cpnAccrual] - (cleanPrice + bi`aiSettle);
