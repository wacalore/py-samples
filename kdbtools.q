...
// .qml.mm requires both args to be matrices; wrap vectors as column matrices
mm:{[A;B]
    $[not qmlLoaded; A mmu B;
      0h=type B;     .qml.mm[A;B];        // B is matrix
      first each .qml.mm[A;flip enlist B]  // B is vector: wrap as column, unwrap result
    ]}
